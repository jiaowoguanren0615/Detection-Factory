...
from models.backbones.vit import VisionTransformerBackbone
...
backbone = VisionTransformerBackbone("eva_02_vit_b_4attn_1024", return_indices=(1, 2, 3), freeze_indices=(0,))
