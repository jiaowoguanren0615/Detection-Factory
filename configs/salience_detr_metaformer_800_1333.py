...
from models.backbones.metaformer import  MetaFormerBackbone
...
backbone = MetaFormerBackbone("caformer_m36", return_indices=(0, 1, 2, 3))
...
#     """
#     ModuleList(
#         (0-3): 4 x Linear(in_features=256, out_features=91, bias=True)
#     )
#     """